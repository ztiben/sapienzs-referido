...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_archive_populate_by" AS ENUM('category', 'selection');
  CREATE TYPE "public"."enum_pages_blocks_carousel_populate_by" AS ENUM('category', 'selection');
  CREATE TYPE "public"."enum_pages_blocks_banner_style" AS ENUM('info', 'warning', 'error', 'success');
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_archive_populate_by" AS ENUM('category', 'selection');
  CREATE TYPE "public"."enum__pages_v_blocks_carousel_populate_by" AS ENUM('category', 'selection');
  CREATE TYPE "public"."enum__pages_v_blocks_banner_style" AS ENUM('info', 'warning', 'error', 'success');
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('es', 'en');
  CREATE TYPE "public"."enum_retailers_default_currency" AS ENUM('COP', 'USD');
  CREATE TYPE "public"."enum_deals_currency" AS ENUM('COP', 'USD');
  CREATE TYPE "public"."enum_deals_sync_source" AS ENUM('manual', 'api');
  CREATE TYPE "public"."enum_deals_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__deals_v_version_currency" AS ENUM('COP', 'USD');
  CREATE TYPE "public"."enum__deals_v_version_sync_source" AS ENUM('manual', 'api');
  CREATE TYPE "public"."enum__deals_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__deals_v_published_locale" AS ENUM('es', 'en');
  CREATE TYPE "public"."enum_deal_reports_status" AS ENUM('pending', 'confirmed', 'dismissed');
  ...
  CREATE TABLE "pages_blocks_archive" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"populate_by" "enum_pages_blocks_archive_populate_by" DEFAULT 'category',
  ...
  CREATE TABLE "pages_blocks_carousel" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"populate_by" "enum_pages_blocks_carousel_populate_by" DEFAULT 'category',
  ...
  CREATE TABLE "pages_blocks_instagram_feed_posts" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"url" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_archive" (
  	...
  	"id" serial PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"populate_by" "enum__pages_v_blocks_archive_populate_by" DEFAULT 'category',
  	"limit" numeric DEFAULT 10,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_carousel" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"populate_by" "enum__pages_v_blocks_carousel_populate_by" DEFAULT 'category',
  	"limit" numeric DEFAULT 3,
  	"populated_docs_total" numeric,
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE "_pages_v_blocks_instagram_feed_posts" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"url" varchar,
  ...
  CREATE TABLE "_pages_v" (
  	...
  	"version_is_system_page" boolean DEFAULT false,
  ...
  CREATE TABLE "retailers" (
  	...
  	"logo_id" integer,
  	"website_url" varchar,
  	"affiliate_tag_template" varchar,
  	"default_currency" "enum_retailers_default_currency" DEFAULT 'COP',
  ...
  CREATE TABLE "deals" (
  	...
  	"deal_price" numeric,
  	"currency" "enum_deals_currency" DEFAULT 'COP',
  	"affiliate_url" varchar,
  	"starts_at" timestamp(3) with time zone,
  	"expires_at" timestamp(3) with time zone,
  	"featured" boolean DEFAULT false,
  	"click_count" numeric DEFAULT 0,
  	"sync_source" "enum_deals_sync_source" DEFAULT 'manual',
  ...
  CREATE TABLE "_deals_v" (
  	...
  	"version_retailer_id" integer,
  	"version_category_id" integer,
  	"version_original_price" numeric,
  	"version_deal_price" numeric,
  	"version_currency" "enum__deals_v_version_currency" DEFAULT 'COP',
  	...
  	"version_sync_source" "enum__deals_v_version_sync_source" DEFAULT 'manual',
  	"version_sync_external_id" varchar,
  	"version_sync_last_synced_at" timestamp(3) with time zone,
  	"version_generate_slug" boolean DEFAULT true,
  	"version_slug" varchar,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"snapshot" boolean,
  	"published_locale" "enum__deals_v_published_locale",
  	"latest" boolean,
  	"autosave" boolean
  );
  
  CREATE TABLE "_deals_v_locales" (
  	"version_title" varchar,
  ...
  CREATE TABLE "deal_reports" (
  	...
  	"deal_id" integer NOT NULL,
  	"user_id" integer,
  	"status" "enum_deal_reports_status" DEFAULT 'pending',
  	"note" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "configuration" (
  	...
  	"site_instagram_url" varchar,
  	"site_facebook_url" varchar,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "pages_blocks_instagram_feed_posts" ADD CONSTRAINT "pages_blocks_instagram_feed_posts_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_instagram_feed"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_rels" ADD CONSTRAINT "pages_rels_deals_fk" FOREIGN KEY ("deals_id") REFERENCES "public"."deals"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_instagram_feed_posts" ADD CONSTRAINT "_pages_v_blocks_instagram_feed_posts_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_instagram_feed"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_rels" ADD CONSTRAINT "_pages_v_rels_deals_fk" FOREIGN KEY ("deals_id") REFERENCES "public"."deals"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "deals" ADD CONSTRAINT "deals_retailer_id_retailers_id_fk" FOREIGN KEY ("retailer_id") REFERENCES "public"."retailers"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "deals" ADD CONSTRAINT "deals_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "deals_locales" ADD CONSTRAINT "deals_locales_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "deals_locales" ADD CONSTRAINT "deals_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."deals"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_deals_v" ADD CONSTRAINT "_deals_v_version_retailer_id_retailers_id_fk" FOREIGN KEY ("version_retailer_id") REFERENCES "public"."retailers"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_deals_v" ADD CONSTRAINT "_deals_v_version_category_id_categories_id_fk" FOREIGN KEY ("version_category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_deals_v_locales" ADD CONSTRAINT "_deals_v_locales_version_meta_image_id_media_id_fk" FOREIGN KEY ("version_meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_deals_v_locales" ADD CONSTRAINT "_deals_v_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_deals_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "favorites" ADD CONSTRAINT "favorites_deal_id_deals_id_fk" FOREIGN KEY ("deal_id") REFERENCES "public"."deals"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "deal_reports" ADD CONSTRAINT "deal_reports_deal_id_deals_id_fk" FOREIGN KEY ("deal_id") REFERENCES "public"."deals"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "deal_reports" ADD CONSTRAINT "deal_reports_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_deal_reports_fk" FOREIGN KEY ("deal_reports_id") REFERENCES "public"."deal_reports"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_instagram_feed_posts_order_idx" ON "pages_blocks_instagram_feed_posts" USING btree ("_order");
  CREATE INDEX "pages_blocks_instagram_feed_posts_parent_id_idx" ON "pages_blocks_instagram_feed_posts" USING btree ("_parent_id");
  ...
  CREATE INDEX "pages_rels_deals_id_idx" ON "pages_rels" USING btree ("deals_id");
  ...
  CREATE INDEX "_pages_v_blocks_instagram_feed_posts_order_idx" ON "_pages_v_blocks_instagram_feed_posts" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_instagram_feed_posts_parent_id_idx" ON "_pages_v_blocks_instagram_feed_posts" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pages_v_rels_deals_id_idx" ON "_pages_v_rels" USING btree ("deals_id");
  ...
  CREATE UNIQUE INDEX "retailers_slug_idx" ON "retailers" USING btree ("slug");
  ...
  CREATE INDEX "deals_retailer_idx" ON "deals" USING btree ("retailer_id");
  CREATE INDEX "deals_category_idx" ON "deals" USING btree ("category_id");
  CREATE INDEX "deals_sync_sync_external_id_idx" ON "deals" USING btree ("sync_external_id");
  ...
  CREATE INDEX "deals_meta_meta_image_idx" ON "deals_locales" USING btree ("meta_image_id","_locale");
  CREATE UNIQUE INDEX "deals_locales_locale_parent_id_unique" ON "deals_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "_deals_v_version_version_retailer_idx" ON "_deals_v" USING btree ("version_retailer_id");
  CREATE INDEX "_deals_v_version_version_category_idx" ON "_deals_v" USING btree ("version_category_id");
  CREATE INDEX "_deals_v_version_sync_version_sync_external_id_idx" ON "_deals_v" USING btree ("version_sync_external_id");
  CREATE INDEX "_deals_v_version_version_slug_idx" ON "_deals_v" USING btree ("version_slug");
  ...
  CREATE INDEX "_deals_v_snapshot_idx" ON "_deals_v" USING btree ("snapshot");
  CREATE INDEX "_deals_v_published_locale_idx" ON "_deals_v" USING btree ("published_locale");
  CREATE INDEX "_deals_v_latest_idx" ON "_deals_v" USING btree ("latest");
  CREATE INDEX "_deals_v_autosave_idx" ON "_deals_v" USING btree ("autosave");
  CREATE INDEX "_deals_v_version_meta_version_meta_image_idx" ON "_deals_v_locales" USING btree ("version_meta_image_id","_locale");
  CREATE UNIQUE INDEX "_deals_v_locales_locale_parent_id_unique" ON "_deals_v_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "favorites_user_idx" ON "favorites" USING btree ("user_id");
  CREATE INDEX "favorites_deal_idx" ON "favorites" USING btree ("deal_id");
  ...
  CREATE INDEX "deal_reports_deal_idx" ON "deal_reports" USING btree ("deal_id");
  CREATE INDEX "deal_reports_user_idx" ON "deal_reports" USING btree ("user_id");
  CREATE INDEX "deal_reports_updated_at_idx" ON "deal_reports" USING btree ("updated_at");
  CREATE INDEX "deal_reports_created_at_idx" ON "deal_reports" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_deal_reports_id_idx" ON "payload_locked_documents_rels" USING btree ("deal_reports_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_instagram_feed_posts" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_instagram_feed_posts" CASCADE;
  ...
  DROP TABLE "deals_locales" CASCADE;
  DROP TABLE "_deals_v" CASCADE;
  DROP TABLE "_deals_v_locales" CASCADE;
  DROP TABLE "favorites" CASCADE;
  DROP TABLE "deal_reports" CASCADE;
  ...
  DROP TYPE "public"."enum_retailers_default_currency";
  DROP TYPE "public"."enum_deals_currency";
  DROP TYPE "public"."enum_deals_sync_source";
  DROP TYPE "public"."enum_deals_status";
  DROP TYPE "public"."enum__deals_v_version_currency";
  DROP TYPE "public"."enum__deals_v_version_sync_source";
  DROP TYPE "public"."enum__deals_v_version_status";
  DROP TYPE "public"."enum__deals_v_published_locale";
  DROP TYPE "public"."enum_deal_reports_status";
